...
export default function Paywall({ open, placement, plan, products, loading = false, onClose, onPurchase, onRestore, onReload }: PaywallProps) {
    ...
    const purchase = async () => {
        ...
        try {
            ...
            setActionError(formatStoreError(purchaseError, 'No se pudo completar la compra. Inténtalo de nuevo.'));
        } finally {
            setBusy(null);
        }
    };
    ...
    const restore = async () => {
        ...
        try {
            ...
            setActionError(formatStoreError(restoreError, 'No encontramos una compra que restaurar.'));
        } finally {
            setBusy(null);
        }
    };
